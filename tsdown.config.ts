/**
 * Browser client bundle for dsh-checkpoints, mirroring the DSH clientBundle
 * protocol: a CJS closure-factory artifact registered through
 * `window.__ModuleLoader__.load`, with CSS Modules inlined as `<style>` tags.
 */
...
const PLATFORM_MODULES = [
  'react', 'react/jsx-runtime', 'react-dom', 'react-dom/client', 'cordis', '@deepseek-ai/cordis',
...
/** Module id this bundle registers under. Must equal package.json `name`. */
